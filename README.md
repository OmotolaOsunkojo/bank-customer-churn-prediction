...
> Suggested captures: EDA segment charts, ROC/PR curve comparison, threshold cost curve, SHAP beeswarm.
...
```text
bank-customer-churn-prediction/
├── churn_prediction.ipynb     # Full analysis notebook (14 sections)
├── requirements.txt
├── README.md
├── .gitignore
├── data/
│   └── Churn_Modelling.csv    # Source: Kaggle Bank Customer Churn dataset
└── screenshots/
    ├── eda_segments.png
